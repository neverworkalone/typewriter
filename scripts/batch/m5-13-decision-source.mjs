...
export function buildM513DecisionSource({
  ...
  const source = {
    ...
    candidate_source: {
      ...
      source_path: 'scripts/batch/m5-13-candidate-source.mjs',
    ...
    selection: {
      ...
      selection_basis: 'source-bound semantic quality threshold; no relation-type quota',
    },
    decisions,
    review: {
      review_pass_id: M5_13_VERIFICATION_PASS_ID,
      ...
      decision_scope: 'complete candidate pool with source-bound deferred reserve',
    },
