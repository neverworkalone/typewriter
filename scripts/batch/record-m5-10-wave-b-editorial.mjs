...
async function completeSession(args) {
  ...
  if (Date.parse(decisionArtifact.finalized_at) <= Date.parse(timingCompletedAt)) throw new Error('editorial decisions must be finalized after all timing passes stop');
  ...
  const completedSession = {
    ...
    note: 'Wave B editorial pass completed from the supplied decisions after all timing passes stopped; no semantic decision was generated by the recorder.',
  };
