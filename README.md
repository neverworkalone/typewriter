...
chronological timing run measures 530.207 seconds across 56 processed starts
(9.467982 seconds per processed start) and passes the fixed gate. Editorial and
audit decision artifacts record `finalized_at` after the last timing stop and are
bound to the completion inputs by digest. The stage only sets
