...
starts (145 included and 5 sense-corrected), and reaches the exact 778-start
target with 156 imported senses. The source-derived gate is
`APPROVE BOUNDED`: all timing passes are measured (31.859 recorder-backed
...
corpus covers the five corrected proposal records plus canonical homonym/POS and
