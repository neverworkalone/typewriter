...
| M6 baseline metrics and quality gates | Versioned canonical snapshot, reproducible metrics, generated report, search evidence, and predeclared quality-gate contract | `docs/m6-1-quality-baseline.md`, `docs/m6-1-quality-baseline.json`, and `scripts/validate/m6-1-quality-baseline.template.md` | Keep the issue-start canonical digest and gate version fixed; later canonical snapshots use a new version. |
