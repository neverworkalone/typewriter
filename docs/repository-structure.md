...
| M6-4 writer-facing quality audit | Reproducible M6-1 sample selection and issue report | `docs/m6-4-quality-audit-sample.json`, `docs/m6-4-quality-audit-report.md`, and `scripts/validate/m6-4-quality-audit.mjs` | Preserve the M6-1 seed, sample rules, canonical digest, and `HOLD` while independent reviews or writer-task evidence are missing. |
