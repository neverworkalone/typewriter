...
verifies that closed issue #157 records APPROVE PUBLIC CUTOVER and the exact same
release commit SHA. This workflow does not change repository visibility.
